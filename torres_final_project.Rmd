...
total_volunteers_data%>%
  ...
  labs(x="Country",
       ...
       title = "Top Ten Countries for Most Volunteers (2019-2020)")+
  theme_bw()
```
...
plastic_hdpe_data%>%
  ggplot()+
  aes(x=fct_reorder(country,total_hdpe,.desc = TRUE), #Ordering data in graph grom greatest to least
      y=total_hdpe)+
  geom_col(fill="royalblue4")+
  labs(x="Country",y="Total HDPE Count",
       title = "Top Ten Countries with Greatest HDPE Platic Polution (2019-2020)")+
  theme_light()
